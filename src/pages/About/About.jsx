const About = () => {
  return (
    <div className="m-auto p-5">
      <h1 className="text-3xl font-semibold">About IRIS Logix Solutions</h1>
      <p>
        IRIS Logix Solutions is a technology company specializing in innovative
        software development, delivering cutting-edge solutions to help
        businesses thrive in the digital era.
      </p>
      <p>
        Our team is dedicated to quality, reliability, and building scalable
        systems that solve real-world problems.
      </p>
      <p>
        We value collaboration, integrity, and continuous learning to stay ahead
